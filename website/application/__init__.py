...
workbook_accounts = pd.read_excel('Accounts.xlsx')
workbook_sources = pd.read_excel('Sources.xlsx')
workbook_objects = pd.read_excel('GeneralObjects.xlsx')
workbook_information_objects = pd.read_excel('InformationObjects.xlsx')
workbook_terms = pd.read_excel('Ontology.xlsx')
workbook_records = pd.read_excel('Records.xlsx')
workbook_art_object_roles = pd.read_excel('ArtObjectRoles.xlsx')
workbook_object_roles = pd.read_excel('ObjectRoles.xlsx')
workbook_event_roles = pd.read_excel('EventRoles.xlsx')
workbook_art_objects = pd.read_excel('ArtObjects.xlsx')
workbook_events = pd.read_excel('Events.xlsx')
